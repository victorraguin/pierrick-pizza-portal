      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Alert className="bg-gradient-to-br from-orange-500/10 to-red-600/10 border-orange-500/20 hover:bg-orange-500/20 transition-colors duration-300">
          ...
          <AlertDescription className="text-gray-800">
            <strong className="text-orange-600 font-title block mb-1">Adresse</strong>
        ...
        <Alert className="bg-gradient-to-br from-orange-500/10 to-red-600/10 border-orange-500/20 hover:bg-orange-500/20 transition-colors duration-300">
          ...
          <AlertDescription className="text-gray-800">
            <strong className="text-orange-600 font-title block mb-1">Horaires du magasin</strong>
        ...
        <Alert className="bg-gradient-to-br from-orange-500/10 to-red-600/10 border-orange-500/20 hover:bg-orange-500/20 transition-colors duration-300">
          ...
          <AlertDescription className="text-gray-800">
            <strong className="text-orange-600 font-title block mb-1">Contact</strong>
        ...
        <Alert className="bg-gradient-to-br from-orange-500/10 to-red-600/10 border-orange-500/20 hover:bg-orange-500/20 transition-colors duration-300">
          ...
          <AlertDescription className="text-gray-800">
            <strong className="text-orange-600 font-title block mb-1">Le camion (18h-22h)</strong>
