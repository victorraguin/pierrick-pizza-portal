        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
          <div>
            ...
            <p className='text-gray-600'>
              Pierrick Pizza - Pizzas à emporter ou sur place à Bourgneuf en
              Retz, avec distributeur de boissons et pizzas, 4 Rue des Jaunins.
            </p>
          </div>
...
'
              ...
              >
                <Phone className='w-4 h-4 mr-2' />
                <span>06 81 40 40 29 (camion)</span>
              </a>
              <a
